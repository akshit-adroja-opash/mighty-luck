  ...
  return (
    <main className="flex w-full flex-none flex-col gap-[60px] lg:gap-[40px] pb-20">
            ...
            >
              ...
              {/* Stats Bar */}
              <div className="relative z-10 flex flex-col lg:flex-row items-center p-[20px_24px] w-full lg:max-w-[1056px] h-auto lg:h-[104px] bg-[#0C1F56] lg:bg-[#091741] rounded-[16px] gap-[12px] lg:gap-[8px] mt-0 lg:mt-auto mx-auto">
                ...
                <div className="flex flex-col flex-none w-full lg:flex-1 gap-[8px]">
                  ...
                  <div className="flex flex-row items-center justify-between p-[10px_16px] bg-[#112F82] rounded-[8px] h-[50px] lg:h-[40px]">
