    ...
    >
      ...
      <div className="flex flex-col gap-[16px] w-full">
        ...
        <div className="hidden md:flex w-full h-[40px] items-center p-0">
          <button
            ...
            className="flex flex-1 h-full items-center justify-center rounded-l-[8px] rounded-r-none font-manrope text-[14px] font-bold tracking-[0.02em] bg-[#1463FF] text-white cursor-pointer"
          >
            Join Now
          </button>
          <button
            ...
            className="flex flex-1 h-full items-center justify-center rounded-r-[8px] rounded-l-none font-manrope text-[14px] font-bold tracking-[0.02em] bg-[#112F82] text-white hover:bg-[#173EAD] transition-all cursor-pointer"
          >
            Log In
          </button>
        </div>
      ...
      <div className="flex flex-col items-center gap-[12px] w-full">
        <button
          type="submit"
          disabled={isLoading}
          className="flex h-[50px] w-full items-center justify-center gap-[10px] rounded-[8px] bg-[#FFC83D] px-[30px] py-[10px] font-manrope text-[14px] leading-[19px] font-bold tracking-[0.02em] text-[#1A1404] transition-all hover:bg-yellow-400 disabled:opacity-50 cursor-pointer"
        >
